    ...
    <>
      {!collapsed || hovered ? (
        <div
          ...
          className={cn(
            'flex  text-default-700 group font-small text-xs capitalize px-[10px] py-3 rounded cursor-pointer transition-all duration-100 hover:bg-primary hover:text-primary-foreground group',
            {
